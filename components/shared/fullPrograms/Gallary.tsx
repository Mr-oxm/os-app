                    ...
                    <div className="flex items-center justify-between card bgOpacity p-4 gap-2"> 
                            ...
                            <div className="relative w-3/4">
                                ...
                                <Input
                                    ...
                                    className="!pl-10 w-full card !shadow-none !drop-shadow-none"
                                />
                            </div>
                        ...
                        <ScrollArea className="flex-grow !h-[90%]">
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-1">
                                {sortedPhotos.map((photo) => (
                                    <Card key={photo.id} className="card bgblur bgOpacity cursor-pointer ring-0 transition-all hover:ring-2 ring-primary" onClick={() => openPreview(photo)}>
