            ...
            <div className="grid grid-cols-5 gap-2 flex-grow">
                ...
                {['0', '.', '⌫', '+', 'MC'].map((btn) => (
                    <Button 
                        ...
                        className={`h-full !text-primary-foreground !text-lg  !text-primary-foreground !text-lg  ${['⌫', 'MC', '+'].includes(btn) ? 'bg-purple-500 hover:bg-purple-600' : 'bg-orange-500 hover:bg-orange-600'}`}
                    >
                        {btn}
                    </Button>
                ))}
