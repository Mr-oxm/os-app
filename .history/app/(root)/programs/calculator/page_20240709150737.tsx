    ...
    return (
        <div className="w-full h-full p-4 flex flex-col  rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-4 gap-2 flex-grow">
                ...
                <Button onClick={() => handleNumberClick('.')} className="full">.</Button>
                <Button onClick={handleEquals} className="full">=</Button>
                <Button onClick={() => handleOperationClick('+')} className="full">+</Button>
                <Button onClick={handleClear} className="col-span-4 full">Clear</Button>
            </div>
        </div>
    )
}
