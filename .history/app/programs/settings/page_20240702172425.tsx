...
return(
    <Link href={name}> <Button className="w-full text-left flex flex-row gap-2 justify-start text-xs text-foreground card bgOpacity hove:bg=popover"><span>{icon}</span>{name} </Button></Link>
)
}
