...
return(
    <Button className="w-full text-left flex flex-row gap-2 justify-start text-xs text-foreground card bg-ba hover:!bg-primary hover:!text-primary-foreground"><span>{icon}</span>{name} 
    </Button>
)
} 
