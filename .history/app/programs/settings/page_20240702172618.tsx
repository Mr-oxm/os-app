...
return(
    <Link href={name}> <Button className="w-full text-left flex flex-row gap-2 justify-start text-xs text-foreground card bgOpacity hover:!bg-primary"><span>{icon}</span>{name} </Button></Link>
)
}
