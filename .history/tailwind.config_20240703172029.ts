...
const config = {
  darkMode: [
    "class", 'dark','windows11-light','windows11-dark', 'ubuntu-light', 'ubuntu-dark','elementary-light', 'elementary-dark', "retro-amber", 'retro-green', 'high-contrast-light', 'high-contrast-dark','solarized-light','solarized-dark'
  ],
  content: [
    './pages/**/*.{ts,tsx}',
    './components/**/*.{ts,tsx}',
