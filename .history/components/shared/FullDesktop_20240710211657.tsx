    ...
    if(isLocked)return(
        ...
        >
            <div className='bgOpacity bgblur w-full h-full flex flex-col items-center justify-center'>
                <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9zbQm_bSDn_0SA74GIvim44xk--fqoJ1biA&s" alt="Profile" width={1000} height={1000} className='w-72 h-72'/>
            </div>
        </main>
    )
    return (
