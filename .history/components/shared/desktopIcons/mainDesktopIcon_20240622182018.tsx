...
const mainDesktopIcon = ({imgSrc, name,hideName= true}:iIcons) => {
    return (
        <div className="bg-transparent hover:bg-white/20 p-2 flex flex-col gap-4 items-center transition-all rounded-lg justify-center h-full w-full aspect-square">
