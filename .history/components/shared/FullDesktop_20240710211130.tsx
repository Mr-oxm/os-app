...
const FullDesktop = ({ children }: { children: React.ReactNode }) => { 
    ...
    if(isLocked)return(
        ...
        >
            <div className='bgOpacity bgblur w-full h-full'>
                <Image src="https://img.icons8.com/?size=100&id=IrCCG4opYvX9&format=png&color=000000" alt="Profile" width={500} height={500}/>
            </div>
        </main>
    )
    return (
