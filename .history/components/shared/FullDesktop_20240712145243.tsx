    ...
    return (
        ...
        >
            ...
            <div className={`flex relative ${taskbarDir==0? "flex-col":( taskbarDir==1? "flex-row":"flex-row-reverse")} flex-grow w-full items-center`}>
                ...
                <HoverCard>
                    <HoverCardTrigger className='text-background w-3/5 absolute bottom-0 h-7 rounded-full border-white hover:border-b-8 blur- transition-all'></HoverCardTrigger>
