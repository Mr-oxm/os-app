...
const FullDesktop = ({ children }: { children: React.ReactNode }) => { 
    ...
    return (
        <main 
            className={`cursor-[url(cur)] flex h-screen w-screen flex-col items-center justify-between max-h-screen max-w-screen overflow-hidden bg-cover bg-center ${fontType}`}
