    ...
    const handleSplit = (direction: string) => {
        switch (direction) {
            ...
            case 'SE':
                ...
                break;
            default:
                // If an unknown direction is passed, do nothing
                break;
        }
    }
                ...
                <TooltipContent className='card flex flex-col gap-2 translate-x-7 !text-xs'>
                    ...
                    <div className='grid grid-cols-2 gap-2 h-fit'>
                        <div className='flex flex-col gap-2 h-full '>
                            <Button onClick={()=>{handleSplit('')}} className='rounded-r-none  !text-xs'>NW</Button>
                            <Button onClick={()=>{handleSplit('')}} className='rounded-r-none  !text-xs'>SW</Button>
                        </div>
                        <div className='flex flex-col gap-2 h-full'>
                            <Button onClick={()=>{handleSplit('')}} className='rounded-l-none  !text-xs'>NE</Button>
                            <Button onClick={()=>{handleSplit('')}} className='rounded-l-none !text-xs '>SE</Button>
                        </div>
                    </div>
                </TooltipContent>
            </Tooltip>
