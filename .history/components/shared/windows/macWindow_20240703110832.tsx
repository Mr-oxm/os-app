...
const MacWindow = ({
    ...
    return (
        ...
        >
            <div className={`flex justify-between row-span-1 p-2 bg-background items-center ${isMaximized ? 'cursor-default' : isDragging ? 'cursor-grabbing' : 'cursor-grab'}`} onMouseDown={handleMouseDown}>
            ...
            <div className='flex-grow row-span-11'>
                {children}
            </div>
        </div>
    );
