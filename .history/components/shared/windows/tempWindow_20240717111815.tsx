    ...
    return(
        <TooltipContent className={`card bgOpacity bgblur flex flex-col gap-2 ${windowDir===0?"translate-x-10":"-translate-x-10"} !text-xs `}>
            ...
            <div className=' card bgOpacity grid grid-cols-2 gap-2'>
                <Button onClick={()=>{handleSplit('left')}} className='rounded-r-none h-20 !text-xs !text-primary-foreground bg->Left</Button>
                <Button onClick={()=>{handleSplit('right')}} className='rounded-l-none h-20 !text-xs !text-primary-foreground bg->Right</Button>
            </div>
            ...
            <div className='grid grid-cols-2 gap-2 h-fit card bgOpacity'>
                <div className='flex flex-col gap-2 h-full '>
                    <Button onClick={()=>{handleSplit('NW')}} className='rounded-r-none rounded-b-none !text-xs !text-primary-foreground bg'>NW</Button>
                    <Button onClick={()=>{handleSplit('SW')}} className='rounded-r-none rounded-t-none !text-xs !text-primary-foreground bg'>SW</Button>
                </div>
                <div className='flex flex-col gap-2 h-full'>
                    <Button onClick={()=>{handleSplit('NE')}} className='rounded-l-none rounded-b-none !text-xs !text-primary-foreground bg-'>NE</Button>
                    <Button onClick={()=>{handleSplit('SE')}} className='rounded-l-none rounded-t-none !text-xs !text-primary-foreground bg-'>SE</Button>
                </div>
            </div>
        </TooltipContent>
    )
