    ...
    return (
        <div className="card bgblur bgOpacity w-full h-full p-4"> 
            <div className="flex justify-between items-center mb-2">
                <div className="flex space-x-2 text-wind">
                    <span className="w-3 h-3 bg-window-exit rounded-full"><X/></span>
                    <span className="w-3 h-3 bg-window-mini rounded-full"><Minus/></span>
                    <span className="w-3 h-3 bg-window-max rounded-full"><Maximize2/></span>
                </div>
