...
const MacWindow = ({
    ...
    return (
        ...
        >
            <div className={`flex justify-between p-2 h-12 bg-background items-center ${isMaximized ? 'cursor-default' : isDragging ? 'cursor-grabbing' : 'cursor-grab'}`} onMouseDown={handleMouseDown}>
