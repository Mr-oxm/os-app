...
const MacWindow = () => {
    ...
    return (
        ...
        >
            <div className={`flex justify-between bg-blue-400 items-center mb-2 ${isMaximized ? 'cursor-default' : isDragging ? 'cursor-grabbing' : 'cursor-grab'}`} onMouseDown={handleMouseDown}>
