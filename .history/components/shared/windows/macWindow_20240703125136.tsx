...
const MacWindow = ({
    ...
    return (
        ...
        >
            <div className={`flex justify-between p-2 h-8 bg-background items-center ${isMaximized ? 'cursor-default' : isDragging ? 'cursor-grabbing' : 'cursor-grab'}`} onMouseDown={handleMouseDown}>
                <div className="flex space-x-2 text-window-foreground w-1/4">
                    <Link onClick={handleExit} className="w-3 h-3 bg-window-exit rounded-full group overflow-hidden">
