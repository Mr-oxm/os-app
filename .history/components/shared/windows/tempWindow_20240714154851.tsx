...
const MacButtons = ({ handleExit, handleMaximize, handleMinimize, windowDir, windowType, hand }:ButtonProps) => (
    <div className={`flex ${windowDir==0?"flex-row": "flex-row-reverse"} gap-2 space-x-2 text-window-foreground w-1/4 items-center`}>
        ...
        <HoverCard>
            <HoverCardTrigger className='!m-0'>
...
const WindowSplit=(handleSplit)=>{
    return(
        <HoverCardContent className='mt-8 w-fit card'>
            <div className='grid grid-cols-2 gap-2'>
                <Button onClick={()=>{handleSplit()}} className='rounded-r-none h-20 '>Left</Button>
                <Button className='rounded-l-none h-20 '>Right</Button>
            </div>
        </HoverCardContent>
    )
}
