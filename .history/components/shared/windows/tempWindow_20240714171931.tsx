    ...
    <div className={`flex ${windowDir==0?"flex-row": "flex-row-reverse"} gap-2 space-x-2 text-window-foreground w-1/4 items-center`}>
        ...
        <TooltipProvider>
            <Tooltip>
                ...
                <TooltipContent className='card translate-x-7'>
                    <div className='grid grid-cols-2 gap-2 mb-2'>
                        <Button onClick={()=>{handleSplit('left')}} className='rounded-r-none h-20 '>Left</Button>
                        <Button onClick={()=>{handleSplit('right')}} className='rounded-l-none h-20 '>Right</Button>
                    </div>
                    <div className='grid grid-cols-2 gap-2 h-fit'>
                        <h2 className='col-span-2 text-xs'></h2>
                        <div className='flex flex-col gap-2 h-full'>
                            <Button onClick={()=>{handleSplit('left')}} className='rounded-r-none  '>Left</Button>
                            <Button onClick={()=>{handleSplit('left')}} className='rounded-r-none  '>Left</Button>
                        </div>
                        <div className='flex flex-col gap-2 h-full'>
                            <Button onClick={()=>{handleSplit('right')}} className='rounded-l-none  '>Right</Button>
                            <Button onClick={()=>{handleSplit('right')}} className='rounded-l-none  '>Right</Button>
                        </div>
                    </div>
                </TooltipContent>
