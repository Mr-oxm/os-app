    ...
    return (
        ...
        > 
            ...
            >
                ...
                />
                <div className="flex-grow flex flex-row gap-4 justify-center items-center text-center text-foreground text-xs font-semibold capitalize">
                    {isMaximized&&<Lock width={5} height={5} />}
                    {programId}
                </div>
