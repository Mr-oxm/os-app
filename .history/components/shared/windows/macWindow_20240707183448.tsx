...
const MacWindow = ({
    ...
    return (
        ...
        >
            <div className={`flex ${windowType!=0} justify-between p-2 h-8 bg-background items-center ${isMaximized ? 'cursor-default' : isDragging ? 'cursor-grabbing' : 'cursor-grab'}`} onMouseDown={handleMouseDown}>
