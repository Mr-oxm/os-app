    ...
    return(
        <TooltipContent className='card flex flex-col gap-2 translate-x-7 !text-xs'>
            ...
            <div className='grid grid-cols-2 gap-2'>
                <Button onClick={()=>{handleSplit('left')}} className='rounded-r-none h-20 !text-xs rounded-b-none'>Left</Button>
            ...
            <div className='grid grid-cols-2 gap-2 h-fit'>
                <div className='flex flex-col gap-2 h-full '>
                    <Button onClick={()=>{handleSplit('NW')}} className='rounded-r-none  !text-xs'>NW</Button>
                    <Button onClick={()=>{handleSplit('SW')}} className='rounded-r-none  !text-xs'>SW</Button>
                </div>
                <div className='flex flex-col gap-2 h-full'>
                    <Button onClick={()=>{handleSplit('NE')}} className='rounded-l-none  !text-xs'>NE</Button>
                    <Button onClick={()=>{handleSplit('SE')}} className='rounded-l-none !text-xs '>SE</Button>
                </div>
            </div>
        </TooltipContent>
    )
