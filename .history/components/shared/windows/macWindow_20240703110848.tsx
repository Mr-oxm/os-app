...
const MacWindow = ({
    ...
    return (
        ...
        >
            <div className={`flex justify-between row-span-1  bg-background items-center ${isMaximized ? 'cursor-default' : isDragging ? 'cursor-grabbing' : 'cursor-grab'}`} onMouseDown={handleMouseDown}>
