...
const MacWindow = () => {
    ...
    const [lastposition, setPosition] = useState({ top: 0, left: 0 });
    ...
    return (
        <div
            className={`card bgblur bgOpacity absolute ${isMaximized ? 'w-full h-full' : 'w-1/2 h-1/2'} p-4 ${isDragging?"":"transition-all"} ease-in-out`} 
