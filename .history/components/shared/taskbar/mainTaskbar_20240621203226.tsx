...
export default function MainTaskbar() {
    ...
    const getIconClass = (index:any) => {
        ...
        if (index === hoverIndex) return "scale-[2] real";
        if (index === hoverIndex - 1 || index === hoverIndex + 1) return "scale-[1.75] real";
        if (index === hoverIndex - 2 || index === hoverIndex + 2) return "scale-[1.5] real";
        return "";
    };
    return (
