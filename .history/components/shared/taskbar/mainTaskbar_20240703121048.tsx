...
import { useIconsStore } from '@/lib/Store/useIconsStoreuseIconsStore';
...
export default function MainTaskbar() {
    ...
    return (
        <div className="ease-in-out bgOpacity bgblur !p-1 m-2 my-1 flex flex-row gap-2 hover:gap-8 transition-all card h-12 ">
            {icons.map((icon: { route: string | UrlObject; imgSrc: string; name: string; }, index: Key | null | undefined) => (
