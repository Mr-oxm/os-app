...
export default function Windows11Taskbar() {
    ...
    return (
        <div className={` bg-background/80 backdrop-blur-md  flex ${taskbarDir===0? "flex-row max-h-14 px-2 w-screen py-1 border-t border-border":"flex-col h-full w-14 px-1 py-2 border-x border-border"} items-center justify-center md:justify-between ${taskbarPos===0?"":"rounded-2xl w-11"}`}> 
