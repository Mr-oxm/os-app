...
const OXMTaskbar = () => {
    ...
    return (
        <div className="absolute w-44 bg-white/60 h-4 bottom-2 transition-all bgblur rounded-full duration-200 group/show hover:w-fit hover:h-12 px-4 hover:py-4 ease-in-out">
            <div className="group-hover/show:flex transition-all flex-row gap-2 hidden h-full delay-200 opacity-0 group-hover/show:opacity-100 ease-in-out duration-1000">
