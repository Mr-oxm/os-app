...
const OXMTaskbar = () => {
    ...
    return (
        <div className="absolute w-44 bg-foreground/80 h-3 bottom-2 transition-all bgblur rounded-full group/show hover:w-fit hover:h-12 px-4 hover:py-4 ease-in-out">
