                                ...
                                <div className="flex flex-row gap-2  w-full">
                                    {TaskbarIcons.map((icon, index) => (
                                        <div key={index} className="w-1/6 h-20">
                                            <Button 
                                                variant="ghost" 
                                                className={`p-6 border-transparent w-full h-full group border hover:border-accent/25 hover:bg-accent/40 flex flex-col`}  
...
// ... rest of the code (SystemTrayMenu) remains unchanged
