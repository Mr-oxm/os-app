                ...
                <div className="flex flex-row items-center h-full py-1 gap-1">
                    ...
                    <Popover open={isStartMenuOpen} onOpenChange={setIsStartMenuOpen}>
                        <PopoverTrigger asChild>
                            <Button variant="ghost" className="p-2 border-transparent border hover:border-accent/25 hover:hover:bg-accent/40 w-11">
                                <Image 
                    ...
                    {TaskbarIcons.map((icon, index) => (
                        ...
                        > 
                            <Button variant="ghost" className={`p-2 border-transparent w-11 h-11 group border hover:border-accent/25 hover:hover:bg-accent/40 ${
                                activeIndex === index ? 'bg-accent/40' : 'hover:bg-accent/40'
                            }`} >
                                <Image 
                                    ...
                                    width={200}
                                    height={200}
                                    className="w-7 h-7 transition-all group-active:h-5 group-active:w-5"
                                />
                            </Button> 
                        </Link> 
                    ))}
