...
const OXMTaskbar = () => {
    ...
    return (
        <div className="absolute w-fit bg-white/60 h- bottom-2 transition-all bgblur rounded-full duration-200 group/show hover:w-fit hover:h-1 px-4 hover:py-1 ease-in-out">
