...
export default function mainTaskbar() {
    return (
        <div className="dock">
            ...
            <DockDesktopIcon imgSrc="https://parsefiles.back4app.com/JPaQcFfEEQ1ePBxbf6wvzkPMEqKYHhPYv8boI1Rc/66c7ae19964613c774a3751916d496b3_yNBo22mIIb.png" name="Terminal" hideName={false}/>
