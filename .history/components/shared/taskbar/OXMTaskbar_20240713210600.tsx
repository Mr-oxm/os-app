...
const OXMTaskbar = () => {
    ...
    return (
        <div className="absolute w-44 h-4 bottom-2 transition-all bg-white rounded-full group/show hover:w-fit hover:h-14">
            <div className="group-hover/show:flex flex-row gap-2 hidden">
