...
const OXMTaskbar = () => {
    ...
    return (
        <div className={`absolute card border-0 bg-white/60 transition-all bgblur !rounded-full duration-200 group/show ease-in-out z-50 ${taskbarDir===0?" hover:w-fit hover:h-14 !px-2 hover:!py-1 h-2 bottom-2 w-fit": (taskbarDir===1? "w-2 h-fit hover:w-14 !px-0 !py-2 right-2":"left-2 w-2 h-fit hover:w-14 px-0 py-2")}   `}>
