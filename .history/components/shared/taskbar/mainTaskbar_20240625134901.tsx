...
export default function MainTaskbar() {
    ...
    return (
        <div className="ease-in-out bg-background/[bg-trans] bgblur p-1 m-2 rounded-xl flex flex-row gap-2 hover:gap-8 transition-all border border-border/20 h-12 ">
