        ...
        <div className="w-screen bg-background/80 backdrop-blur-md border-t border-border max-h-14 flex flex-row items-center justify-between px-2"> 
                ...
                <div className="flex justify-end w-14"> 
                    ...
                    <Popover>
                        <PopoverTrigger>
                            {/* Date and Time */}
                            <div className="text-xs p-1.5 border-transparent  group border hover:border-accent/25 hover:bg-accent/40 flex flex-row gap-2 ">
                                <div className="flex flex-col">
                                    <span className="w-fit"> {currentTime}</span>
