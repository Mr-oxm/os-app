...
const OXMTaskbar = () => {
    ...
    return (
        <div className={`taskbar-buffer absolute card bg-background/50 hover:bg-background/15 hover:!border-2 hover:!border-backbg-background/50 transition-all bgblur !rounded-full duration-200 group/show ease-in-out z-50 ${
            taskbarDir === 0
