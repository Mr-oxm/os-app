        ...
        <div className="w-screen bg-background/80 backdrop-blur-md border-t border-border max-h-14 flex flex-row items-center justify-between px-2"> 
                ...
                <div className="flex flex-row items-center h-full py-1 gap-1">
                    ...
                    <Popover open={isStartMenuOpen} onOpenChange={setIsStartMenuOpen}>
                        ...
                        <PopoverContent className="w-fit p-4 rounded-lg  bg-background/80 backdrop-blur-md " side="top">
                            <div className="grid grid-rows-3 gap-4 w-full">
                                <div className="col-span-2 w-full">
                                    <Input placeholder="Type here to search" className="mb-4 rounded-full" />
                                            ...
                                            > 
                                                <Button variant="ghost" className={`p-6 border-transparent w-full h-full  group border hover:border-accent/25 hover:bg-accent/40 flex flex-col`} >
                                                    <Image 
                                                        ...
                                                        width={200}
                                                        height={200}
                                                        className="w-12 h-12 transition-all group-active:h-10 group-active:w-5"
                                                    />
