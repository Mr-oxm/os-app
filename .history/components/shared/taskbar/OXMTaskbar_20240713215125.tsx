...
const OXMTaskbar = () => {
    ...
    return (
        <div className="absolute bg-white/60 h-4 bottom-2 transition-all bgblur rounded-full duration-200 group/show delay-1000  hover:h-12 px-4 hover:py-4 ease-in-out">
            <div className="group-hover/show:flex transition-all flex-row gap-2 hidden h-full delay-1000 ease-in-out">
