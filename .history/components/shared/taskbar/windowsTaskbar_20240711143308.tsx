...
export default function Windows11Taskbar() {
    ...
    return (
        <div className={`w-screen bg-background/80 backdrop-blur-md border-t border-border flex ${taskbarDir===0? "flex-row max-h-14 px-2":"flex-col w-12 py-2"} items-center justify-center md:justify-between `}> 
