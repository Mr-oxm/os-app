...
const OXMTaskbar = () => {
    ...
    return (
        <div className={`absolute  bg-white/60 transition-all bgblur rounded-full duration-200  ease-in-out z-50 ${taskbarDir===0?"hover:h-14 px-4 hover:py-1 h-4 bottom-2 w-fit":""}`}>
