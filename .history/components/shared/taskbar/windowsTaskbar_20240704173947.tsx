...
export default function Windows11Taskbar() {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-background/80 backdrop-blur-md border-t border-border max-h-12">
            <div className="flex items-center justify-between max-h-full px-2 py-2">
