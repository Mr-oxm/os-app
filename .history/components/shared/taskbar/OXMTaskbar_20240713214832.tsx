...
const OXMTaskbar = () => {
    ...
    return (
        <div className="absolute w-44 bg-white/60 h-4 bottom-2 transition-all bgblur rounded-full duration-200 group/show hover:w-9 hover:h-12 px-4 hover:py-4 ease-in-out delay-500">
