...
const OXMTaskbar = () => {
    ...
    return (
        <div className={`absolute  bg-white/60 transition-all bgblur rounded-full duration-200 group/show ease-in-out z-50 ${taskbarDir===0?" hover:w-fit hover:h-14 px-4 hover:py-1 h-4 bottom-2 w-fit":"w-4 h-fit hover:w-14 py-4 px-1 left-1"}`}>
