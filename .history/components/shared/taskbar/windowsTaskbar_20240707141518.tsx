    ...
    return (
        <div className="w-screen bg-background/80 backdrop-blur-md border-t border-border max-h-14 flex flex-row items-center justify-between px-2"> 
                ...
                <Popover>
                    <PopoverTrigger>
                        {/* System Tray */}
                        <Button variant="ghost" className="p-1.5 border-transparent group border hover:border-accent/25 hover:bg-accent/40">
                    ...
                    {/* Date and Time */}
                    <Button variant="ghost" className="text-xs p-1.5 border-transparent  group border hover:border-accent/25 hover:bg-accent/40 flex flex-row gap-1">
