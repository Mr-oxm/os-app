...
const OXMTaskbar = () => {
    ...
    return (
        <div className={`absolute w-fit bg-white/60 transition-all bgblur rounded-full duration-200  ease-in-out z-50 ${taskbarDir===0?"group/show hover:w-fit hover:h-14 px-4 hover:py-1h-4 bottom-2 ":""}`}>
