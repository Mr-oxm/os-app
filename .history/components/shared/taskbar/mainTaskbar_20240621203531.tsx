...
export default function MainTaskbar() {
    ...
    const getIconClass = (index:any) => {
        ...
        if (index === hoverIndex) return "scale-[2] hover:relative hover:bottom-6";
        if (index === hoverIndex - 1 || index === hoverIndex + 1) return "scale-[1.75] hover:relative hover:bottom-6";
        if (index === hoverIndex - 2 || index === hoverIndex + 2) return "scale-[1.5] hover:relative hover:bottom-6";
        return "";
    };
    return (
