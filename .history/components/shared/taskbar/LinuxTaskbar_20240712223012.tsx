...
export default function LinuxTaskbar() {
    ...
    return (
        <div className={` bg-background/80 bgblur flex ${taskbarDir===0? "flex-row max-h-14 px-2 w-fit py-1":"flex-col h-full w-14 px-1 py-2 border-x border-border"} items-center justify-between md:justify-between ${taskbarPos===0?"":"rounded-2xl w-[90vw]"}`}> 
