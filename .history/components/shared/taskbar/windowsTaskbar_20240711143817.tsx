        ...
        <div className={` bg-background/80 backdrop-blur-md border-t border-border flex ${taskbarDir===0? "flex-row max-h-14 px-2 w-screen":"flex-col h-full w-12 py-2"} items-center justify-center md:justify-between `}> 
                ...
                <div className={`hidden md:flex ${taskbarDir===0? "flex-row  w-14":"flex-col h-14"} justify-end`}> 
                    <Popover>
                        <PopoverTrigger>
                            {/* System Tray */}
                            <div className={`p-1.5 border-transparent group border hover:border-accent/25 hover:bg-accent/40 flex ${taskbarDir===0? "flex-row h-full":"flex-col"} gap-2  items-center rounded-md`}>
