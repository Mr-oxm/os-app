...
export default function Windows11Taskbar() {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-background/80 backdrop-blur-md border-t border-border max-h-14">
            <div className="flex items-center justify-between max-h-full px-2">
                ...
                <div className="flex items-center h-full">
                    ...
                    {TaskbarIcons.map((icon, index) => (
                        <Link href={icon.route}
                            className={` !p-2  transition-colors card !border-0 hover:border hover:!border-border ${
                ...
                <div className="flex justify-end w-14"> 
                    ...
                    {/* System Tray */}
                    <Button variant="ghost" className="flex flex-row gap-1 rounded-md hover:bg-accent/50">
