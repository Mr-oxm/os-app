...
export default function Windows11Taskbar() {
    ...
    return (
        <div className={` bg-background/80 backdrop-blur-md  flex ${taskbarDir===0? "flex-row max-h-14 px-2 w-screen py-1 border-t border-border":"flex-col h-full w-14 px-1 py-2 border-x border-border"} items-center justify-center md:justify-between `}> 
                    ...
                    <Popover>
                        <PopoverTrigger>
                            ...
                            <div className={`text-xs p-1.5 border-transparent  group border hover:border-accent/25 hover:bg-accent/40 flex ${taskbarDir===0? "flex-row":"flex-col"} gap-2 items-center rounded-md justify-center`}>
                                <div className={`flex flex-col text-right ${taskbarDir===0? "text-right ":"text-center items-center"}`}>
                                    <span className={` text-wrap ${taskbarDir===0? "":"w-5/6 text-center"} `}> {currentTime}</span>
                                    <span className={`className={` text-wrap ${taskbarDir===0? "":"w-5/6 text-center"} `}`}> {currentDate}</span>
                                </div>
