...
function SystemTrayMenu() {
    ...
    <PopoverContent className="w-80 p-0">
        <div className="grid grid-cols-3 gap-2 p-4">
            ...
            <Button key={label} variant="ghost" className="flex flex-col items-center justify-center h-24 p-1.5 border-transparent w-11 h-11 group border hover:border-accent/25 hover:bg-accent/40">
