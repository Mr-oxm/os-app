...
const OXMTaskbar = () => {
    ...
    return (
        <div className="absolute bg-white/60 h-4 bottom-2 transition-all bgblur rounded-full duration-200 group/show delay  hover:h-12 px-4 hover:py-4 ease-in-out">
