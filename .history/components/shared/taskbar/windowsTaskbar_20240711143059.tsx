...
export default function Windows11Taskbar() {
    ...
    return (
        <div className={`w-screen bg-background/80 backdrop-blur-md border-t border-border max-h-14 flex ${taskbarDir===0? "flex-row max-h-14":"flex-col w-12"} items-center justify-center md:justify-between px-2`}> 
