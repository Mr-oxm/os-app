...
export default function mainTaskbar() {
    return (
        <div className="dock">
            ...
            <DockDesktopIcon imgSrc="https://parsefiles.back4app.com/JPaQcFfEEQ1ePBxbf6wvzkPMEqKYHhPYv8boI1Rc/db1241171cb324621c222ad116d80972_f8Y65N7lzM.png" name="Tras" hideName={false}/>
