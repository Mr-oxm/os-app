...
export default function LinuxTaskbar() {
    ...
    return (
        <div className={` bg-background/80 bgblur card flex ${taskbarDir===0? "flex-row max-h-14 !p-2 w-fit":"flex-col-reverse h-full w-14 px-1 py-2 !rounded-none"} items-center justify-between md:justify-between ${taskbarPos===0?"":"rounded-2xl w-[90vw]"}`}> 
