...
export default function MainTaskbar() {
    ...
    const getIconClass = (index:any) => {
        ...
        if (index === hoverIndex) return "scale-[2] relative bottom-6";
        if (index === hoverIndex - 1 || index === hoverIndex + 1) return "scale-[1.75] relative bottom-6";
        if (index === hoverIndex - 2 || index === hoverIndex + 2) return "scale-[1.5] relative bottom-6";
        return "";
    };
    return (
