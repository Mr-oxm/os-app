...
const OXMTaskbar = () => {
    ...
    return (
        <div className="absolute w-fit bg-white/60 h-10 bottom-2 transition-all bgblur rounded-full duration-200 group/show hover:w-fit hover:h-12 px-4 hover:py-1 ease-in-out">
