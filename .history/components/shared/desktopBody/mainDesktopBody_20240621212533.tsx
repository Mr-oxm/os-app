...
const mainDesktopBody = () => {
    return (
        <div className=" w-full flex-1 grid grid-cols-12 grid-rows-6 gap-2">
            ...
            <MainDesktopIcon imgSrc="https://parsefiles.back4app.com/JPaQcFfEEQ1ePBxbf6wvzkPMEqKYHhPYv8boI1Rc/603d0ef71252ee0d12081181dfd66041_FPDXUjhF0d.png" name="WorkWork"/>    
        </div>
    )
}
