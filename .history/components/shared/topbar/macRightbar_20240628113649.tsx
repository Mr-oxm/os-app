...
const DateMenu= ()=>{ 
    return( 
        <div className="flex flex-col gap-2 p-2 bg-background w-full card ite">
            <div className="flex flex-col gap-1">
                <Label className=" !text-xs font-bold capitalize text-destructive">Tuesday</Label>
                <Label className="text-foreground/50 !text-xs font-thin">25</Label>
