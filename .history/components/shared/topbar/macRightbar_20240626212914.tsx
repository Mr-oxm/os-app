    ...
    return( 
        <div className="flex flex-row gap-2">
            <div className="flex flex-row !text-xs justify-between p-2 items-center">
                ...
                <Label className="!text-xs font-thin">0%</Label>
                
            </div> 
            <hr className="border-foreground/15 mx-3 my-1"  />
            <Label className="!text-xs font-thin">Power Source: Battery</Label>
            <hr className="border-foreground/15 mx-3 my-1"  />
            <Label className="!text-xs font-thin">No Apps Using Significant Energy</Label>
