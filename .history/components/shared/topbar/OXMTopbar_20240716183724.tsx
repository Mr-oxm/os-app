...
const OXMenu=({handleProgram}:{handleProgram:Function})=>{
    ...
    const { openProgram, openedPrograms, minimizeProgram, maximizeProgram, active } = useOSMemoryStore();
    return(
        <PopoverContent className="card bgblur bgOpacity ml-5 mt-1 grid grid-cols-8 gap-2 w-96 ">
            {/* left section  */}
            <div className="flex flex-col justify-between gap-2 col-span-7 bgOpacity card">
