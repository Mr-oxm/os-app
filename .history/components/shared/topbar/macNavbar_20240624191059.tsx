                ...
                <NavigationMenuList className="flex flex-row p-0 h-full">
                    {MenuLinks.map(menu => (
                        <NavigationMenuItem key={menu.Name}>
                            <NavigationMenuTrigger className="bg-transparent py-0 px-4 h-full !text-foreground !text-xs hover:bg-background/50">
                                {menu.Name}
                            </NavigationMenuTrigger>
                                ...
                                {menu.content.map((item, index) => (
                                    item === 'separator' ? 
                                        ...
                                        <NavigationMenuLink key={index}>
                                            <Button className="w-full !text-xs justify-start bg-transparent h-auto hover:bg-background/15 text-foreground">
                                                {item}
                                            </Button>
                                        </NavigationMenuLink>
                                ))}
