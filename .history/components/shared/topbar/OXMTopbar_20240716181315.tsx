    ...
    return(
        <PopoverContent className="card bgblur bg-background/80 ml-5 mt-1 grid grid-cols-6 w-96 ">
            ...
            <div className="flex flex-col justify-end text-xs">
                <div className="flex flex-col justify-center items-center group gap-2 font-bold transition-transform hover:h-20">
                    <Image 
                    ...
                    />
                    <Label className="opacity-0 group-hover:block transition-all">Guest</Label>
                </div>
                <div></div>
            </div>
        </PopoverContent>
