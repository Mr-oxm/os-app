    ...
    return(
        <PopoverContent className="card bgblur bg-background/80 ml-5 mt-1 grid grid-cols-6 w-96 ">
            ...
            <div className="flex flex-col justify-end text-xs">
                <div className="flex flex-col justify-center items-center relative group gap-2 font-bold transition-transform">
                    <Image 
                    ...
                    />
                    <Label className="absolute bottom-4 opacity-0 group-hover:opacity-100 transition-all">Guest</Label>
                </div>
                <div></div>
            </div>
        </PopoverContent>
