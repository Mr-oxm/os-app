                    ...
                    <DialogContent className="flex flex-col items-center">
                        ...
                        <div className="flex flex-row gap-4">
                            {TaskbarIcons.map((icon, index) => (
                                ...
                                > 
                                    <Button variant="ghost" className={`p-1.5 border-transparent w-11 h-11 group border hover:border-accent/25 hover:bg-accent/40 'bg-accent/40 'hover:bg-accent/40'
                                    }`} >
                                        <Image 
