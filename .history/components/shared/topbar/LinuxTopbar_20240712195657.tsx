                        ...
                        <div className="flex flex-row flex-wrap items-center justify-center gap-4">
                            {TaskbarIcons.map((icon, index) => (
                                <Link href={icon.route} 
                                    className=""
                                > 
                                    <Button variant="ghost" className={`p-1.5 border-transparent w-20 h-20 group border hover:border-accent/25 hover:bg-accent/40 'bg-accent/40 hover:hover:bg-accent/40 flex flex-col gap-2
                                    }`} >
                                        <Image 
