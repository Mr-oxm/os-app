                    ...
                    <PopoverContent>
                        ...
                        <div className="flex flex-col justify-start gap-4">
                            {TaskbarIcons.map((icon, index) => ( 
                                    <Button key={index} onClick={() => handleProgram(icon.id)} variant="ghost" className={`p-1.5 flex flex-row gap-4 border-transparent w-full h-20 group border hover:border-accent/25 hover:bg-accent/40 items-start ${
