                ...
                <ScrollArea className="max-h-72">
                    <div className="!flex !flex-col gap-1 items-center justify-start min-h-64">
                        {filteredIcons.map((icon, index) => ( 
                            <Button key={index} onClick={() => handleProgram(icon.id)} variant="ghost" className={`!p-1.5 flex flex-row gap-3 card  w-full h-10 group bgOpacity hover:!bg-foreground/10 ease-in-out justify-start active:scale-110 transition-all drop-shadow ${
