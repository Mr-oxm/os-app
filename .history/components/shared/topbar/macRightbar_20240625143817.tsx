            ...
            <NavigationMenu className="h-full !text-xs">
                    ...
                    {/*------------ item start---------- */}
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="flex flex-col p-2  w-auto md:w-96 rounded-mdound">
                                            <NavigationMenuLink >
                    ...
                    {/*------------ item start---------- */}
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="flex flex-col p-2  w-auto md:w-96 roundeoreground">
                                            <NavigationMenuLink >
                                                <Button className="w-full !text-xs justify-start bg-transparent h-auto hover:bg-background/30 text-foreground">
                    ...
                    {/*------------ item start---------- */}
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="flex flex-col p-2  w-auto md:w-96 r text-foreground">
                                            <NavigationMenuLink >
                                                <Button className="w-full !text-xs justify-start bg-transparent h-auto hover:bg-background/30 text-foreground">
                    ...
                    {/*------------ item start---------- */}
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="flex flex-col p-2  w-auto md:w-96 rounded-m text-foreground">
                                            <NavigationMenuLink >
                                                <Button className="w-full !text-xs justify-start bg-transparent h-auto hover:bg-background/30 text-foreground">
                    ...
                    {/*------------ item start---------- */}
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="flex flex-col p-2  w-auto md:w-96 rounded-md border- text-foreground">
                                            <NavigationMenuLink >
                                                <Button className="w-full !text-xs justify-start bg-transparent h-auto hover:bg-background/30 text-foreground">
