                ...
                <NavigationMenuList className="flex flex-row p-0 h-full">
                    {MenuLinks.map(menu => (
                        <NavigationMenuItem key={menu.Name}>
                            ...
                            <NavigationMenuContent className="flex flex-col py-1 px-2 bg-black/15 focus:backdrop-blur-sm focus:bg-transparent gap-2 w-auto md:w-96 rounded-md border">
