        ...
        <PopoverContent className="card bgblur bgOpacity ml-4 mt-1 grid grid-cols-6 gap-2 w-96 ">
            ...
            <div className="flex flex-col justify-between gap-2 col-span-5 bgOpacity card">
                <ScrollArea className="!flex !flex-col items-center justify-start">
                    {TaskbarIcons.map((icon, index) => ( 
                            <Button key={index} onClick={() => handleProgram(icon.id)} variant="ghost" className={`!p-1.5 mb-1 flex flex-row gap-3 card  w-full h-10 group bgOpacity hover:!bg-foreground/10 justify-start active:scale-110 transition-all ${
            ...
            <div className="flex flex-col justify-between text-xs !p-1 items-center card bgOpacity">
                <div className="flex flex-col justify-center items-center group gap-1 transition-transform ">
                    ...
                    width={1000} 
                    height={1000} 
                    className='w-10 h-10 !rounded-full !p-1 card bgOpacity transition-transform duration-300 hover:!bg-foreground/20'
                    />
                    <Label className="opacity-0 group-hover:opacity-100 transition-all mt-6 ease-in-out group-hover:m-0">Guest</Label>
                </div>
                <div className="flex flex-col gap-2 justify-end">
                    <Button className="!rounded-full w-8 h-8 !p-1 card bgOpacity hover:!bg-foreground/10">
