                    ...
                    <PopoverContent className="card bgblur bg-background/80 ml-5 grid grid-cols-2">
                        ...
                        <div className="flex flex-col items-center justify-start gap-4">
                            {TaskbarIcons.map((icon, index) => ( 
                                    <Button key={index} onClick={() => handleProgram(icon.id)} variant="ghost" className={`!p-1.5 flex flex-row gap-3 card border-transparent w-full h-12 group border hover:border-accent/25 hover:bg-accent/40 justify-start ${
                                        ...
                                        <Image 
                                            ...
                                            width={200}
                                            height={200}
                                            className="w-9 h-9 transition-all group-active:h-5 group-active:w-5"
                                        />
