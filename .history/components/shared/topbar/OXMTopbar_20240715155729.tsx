                    ...
                    <PopoverContent>
                        ...
                        <div className="flex flex-row flex-wrap items-center justify-center gap-4">
                            {TaskbarIcons.map((icon, index) => ( 
                                    <Button key={index} onClick={() => handleProgram(icon.id)} variant="ghost" className={`p-1.5 flex flex-col gap-4 border-transparent w-20 h-20 group border hover:border-accent/25 hover:bg-accent/40 ${
