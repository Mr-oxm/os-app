...
import { Bluetooth, Wifi, Battery, Settings2, Share, Moon, ligh} from "lucide-react"
...
const SettingsMenu= ()=>{
    ...
    return(
        <div className="grid grid-cols-2 grid-rows-5 w-full !text-xs">
            {/* top section  */}
            <div className="row-span-2 col-span-1 flex flex-row gap-4">
                {/* System options */} 
                <div className="flex flex-col gap-4 bgOpacity p-4 rounded-sm flex-1">
            ...
            <div className="col-span-1 row-span-1 bgOpacity p-4 rounded-sm flex flex-row gap-2 items-center">
                <Toggle className="bgOpacity rounded-full w-10 h-10 p-1">
                    <Moon/>
                </Toggle>
            ...
            <div className="bgOpacity p-4 rounded-sm flex flex-row gap-2 items-center">
                <Toggle className="bgOpacity rounded-full w-10 h-10 p-1">
                    <Moon/>
                </Toggle>
                <Label className="font-bold">Do Not Disturb</Label>
