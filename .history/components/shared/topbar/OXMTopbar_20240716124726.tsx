                    ...
                    <PopoverContent className="card bgblur bg-background/80 ml-5 grid grid-cols-2">
                        ...
                        <div className="flex flex-col items-center justify-start gap-2">
                            {TaskbarIcons.map((icon, index) => ( 
                                    <Button key={index} onClick={() => handleProgram(icon.id)} variant="ghost" className={`!p-1.5 flex flex-row gap-3 card !border-transparent w-full h-12 group border hover:!border-accent/25 hover:bg-primary  justify-start active:scale-110 transition-all ${
