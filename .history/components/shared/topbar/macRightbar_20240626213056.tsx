    ...
    return( 
        <div className="flex flex-col gap-2 p-2">
            <div className="flex flex-row !text-xs justify-between  items-center">
                ...
                <Label className="text-foreground/ !text-xs font-thin">0%</Label>
                
            </div> 
            <hr className="border-foreground/15  my-1"  />
            <Label className="text-foreground/ !text-xs font-thin">Power Source: Battery</Label>
            <hr className="border-foreground/15  my-1"  />
            <Label className="text-foreground/ !text-xs font-thin">No Apps Using Significant Energy</Label>
