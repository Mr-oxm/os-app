...
const LinuxTopbar = () => {
    ...
    return (
        <div className={` bg-background/80 backdrop-blur-md  flex flex-row max-h-14 px-2 w-screen py-1 border-t border-border`}> 
                ...
                <div className={`hidden md:flex flex-row w-1/5 h-full `}> 
                    <Popover>
                        <PopoverTrigger>
                            {/* System Tray */}
                            <div className={`p-1.5 border-transparent group border hover:border-accent/25 hover:bg-accent/40 flex flex-row h-full${taskbarDir===0? "":"flex-col w-full"} gap-2  items-center rounded-md`}>
