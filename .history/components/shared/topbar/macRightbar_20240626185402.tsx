            ...
            <NavigationMenu className="h-full !text-xs">
                    ...
                    {/*------------ item start---------- */}
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="flex flex-col p-2  w-auto md:w- text-foreground">
                                            <NavigationMenuLink >
...
const SettingsMenu= ()=>{
    ...
    return(
        <div className="grid grid-cols-1 grid-rows-5 w-full !text-xs">
            {/* top section  */}
            <div className="row-span-2 flex flex-row gap-4">
                {/* System options */} 
