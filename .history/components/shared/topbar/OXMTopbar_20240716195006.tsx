...
const OXMenu=()=>{
    ...
    return (
        <PopoverContent className="card bgblur bgOpacity ml-4 mt-1 grid grid-cols-6 gap-2 w-80 md:w-96 ">
            {/* left section  */}
            <div className="flex flex-col justify-between gap-2 col-span-4 bgOpacity card">
