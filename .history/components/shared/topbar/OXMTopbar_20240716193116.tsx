    ...
    <PopoverContent className="w-80 card bgOpacity backdrop-blur-md mt-1 overflow-hidden">
        <div className="grid grid-cols-3 gap-2 card bgOpacity">
            ...
            <div className="flex flex-col items-center gap-2">
                <Button key={label} variant="ghost" className="card bgOpacity cursor-pointer h-20 overflow-hidden hover:ring-2 w-full flex flex-col gap-2 group transition-all">
