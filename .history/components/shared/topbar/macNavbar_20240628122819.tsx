                                ...
                                {menu.content.map((item, index) => (
                                    item.name === 'separator' ?
                                        ...
                                        <NavigationMenuLink key={index}>
                                            <Button className="w-full !text-xs justify-start bg-transparent h-auto hover:bg-primary hover:!text-primary-foreground text-foreground disabled:text-foreground/50"
                                                disabled={item.disabled}>
                                                {item.name} {item.shortcut && <span className="ml-auto">{item.shortcut}</span>}
                                            </Button>
                                        </NavigationMenuLink>
                                ))}
                            </NavigationMenuContent>
