            ...
            <NavigationMenu className="h-full !text-xs">
                    ...
                    {/*------------ item start---------- */}
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="flex flex-col p-2  w-auto md:w-96">
                                            <NavigationMenuLink >
                    ...
                    {/*------------ item start---------- */}
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="flex flex-col p-2  w-auto md:round">
                                            <NavigationMenuLink >
                                                <Button className="w-full !text-xs justify-start bg-transparent h-auto hover:bg-background/30 text-foreground">
                    ...
                    {/*------------ item start---------- */}
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="flex flex-col p-2  w-auext-foreground">
                                            <NavigationMenuLink >
                                                <Button className="w-full !text-xs justify-start bg-transparent h-auto hover:bg-background/30 text-foreground">
                    ...
                    {/*------------ item start---------- */}
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="flex flex-col p-2  w-auto md:w-9ext-foreground">
                                            <NavigationMenuLink >
                                                <Button className="w-full !text-xs justify-start bg-transparent h-auto hover:bg-background/30 text-foreground">
                    ...
                    {/*------------ item start---------- */}
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="flex flex-col p-2  w-auto md:w-96 rounded-mext-foreground">
                                            <NavigationMenuLink >
                                                <Button className="w-full !text-xs justify-start bg-transparent h-auto hover:bg-background/30 text-foreground">
