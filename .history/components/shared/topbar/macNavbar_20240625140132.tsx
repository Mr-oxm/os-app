                ...
                <NavigationMenuList className="flex flex-row p-0 h-full">
                    {MenuLinks.map(menu => (
                        <NavigationMenuItem key={menu.Name}>
                            ...
                            <NavigationMenuContent className="flex flex-col p-2  w-auto md:w-96 rounded-md border-2 border-border/20 text-foreground overflow-hidden">
                                {menu.content.map((item, index) => (
                                    item === 'separator' ? 
                                        <hr className="border-foreground/15 mx-3 " key={index} /> 
