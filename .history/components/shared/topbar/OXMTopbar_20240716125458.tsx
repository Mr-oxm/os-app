                    ...
                    <PopoverContent className="card bgblur bg-background/80 ml-5 mt-1 grid grid-cols-2">
                        ...
                        <div className="flex flex-col items-center justify-start gap-2">
                            {TaskbarIcons.map((icon, index) => ( 
                                    <Button key={index} onClick={() => handleProgram(icon.id)} variant="ghost" className={`!py-0 flex flex-row gap-3 card !border-transparent w-full h-12 group border hover:!border-border/50 hover:bg-primary  justify-start active:scale-110 transition-transform ${
