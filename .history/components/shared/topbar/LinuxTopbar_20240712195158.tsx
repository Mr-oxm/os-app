    ...
    return (
        <div className={` bg-background/80 backdrop-blur-md  flex flex-row justify-between h-6 px-4 w-screen py-1 `}> 
                ...
                <Dialog>
                    ...
                    <DialogContent className="flex flex-col item">
                        ...
                        <div>
                            {TaskbarIcons.map((icon, index) => (
                                ...
                                > 
                                    <Button variant="ghost" className={`p-1.5 border-transparent w-11 h-11 group border hover:border-accent/25 hover:bg-accent/40 'bg-accent/40 border-accent/25' : 'hover:bg-accent/40'
                                    }`} >
                                        <Image 
