...
import { Bluetooth, Wifi, Battery, Settings2, Share, Moon, Sun} from "lucide-react"
...
const SettingsMenu= ()=>{
    ...
    return(
        <div className="grid grid-cols-4 grid-rows-5 w-full !text-xs">
            {/* top section  */}
            <div className="flex flex-col gap-4 bgOpacity p-4 rounded-sm row-span-2 col-span-2 ">
                ...
                <div className="flex flex-row gap-2 items-center">
                    ...
                    <div className="flex flex-col gap-2 ">
                        <Label className="font-bold !text-xs">{icon.name} </Label>
                        <Label className="!text-xs">{icon.status? 'On': 'Off'}</Label>
                    </div>
                </div> 
                ))}
            </div> 
            <div className="col-span-2 row-span-1 bgOpacity p-4 rounded-sm flex flex-row gap-2 items-center">
                <Toggle className="bgOpacity rounded-full w-10 h-10 p-1">
                    <Moon/>
                </Toggle>
                <Label className="font-bold !text-xs">Do Not Disturb</Label>
            </div>

            <div className="bgOpacity p-4 rounded-sm flex flex-col gap-2 items-center col-span-1 row-span-1">
                <Sun/>
                <Label className="font-bold !text-xs text-center">Keyboard Brightness</Label>
            </div>
