    ...
    return(
        <PopoverContent className="card bgblur bg-background/80 ml-5 mt-1 grid grid-cols-6 w-96 ">
            ...
            <div className="flex flex-col justify-end text-xs">
                <div className="flex flex-col justify-center items-center group gap-2 font-bold transition-all">
                    <Image 
                    ...
                    width={1000} 
                    height={1000} 
                    className='w-10 h-10 !rounded-full !p-1 card bgOpacity transition-all duration-300 hover:scale-105'
                    />
                    <Label className="hidden group-hover:block">Guest</Label>
                </div>
                <div></div>
            </div>
        </PopoverContent>
