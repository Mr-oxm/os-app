...
const MusicPlayer = () => {
    ...
    return (
        <div className=" p-4 rounded-lg col-span-8 row-span-2 group ">
            ...
            <canvas ref={canvasTopRef} width="2000" height="100" className=" w-full h-20 text-background opacity-50" />
            <canvas ref={canvasBottomRef} width="2000" height="50" className="mb-4 w-full h-8 text-background opacity-20" />
