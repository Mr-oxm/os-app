...
const WeatherWidget: React.FC = () => {
    ...
    return (
        <Card className="col-span-2 row-span-2 border-transparent bg-transparent shadow-none select-none backdrop-blur-0 hover:!bgOpacity hover:bgblur transition-all ease">
