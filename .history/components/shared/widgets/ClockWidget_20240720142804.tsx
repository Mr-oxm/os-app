...
const ClockWidget = () => {
    ...
    return (
        <div className="select-none  md:col-span-4  md:row-span-2 h-full bg-transparent border-transparent flex flex-col relative gap-10 items-center justify-center "> 
