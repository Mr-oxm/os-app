...
const WeatherWidget: React.FC = () => {
    ...
    return (
        <Card className="col-span-4 row-span-1 md:col-span-2 md:row-span-2 !border-transparent bg-transparent shadow-none select-none backdrop-blur-0 hover:!bgOpacity hover:bgblur transition-all ease-in-out card flex flex-col justify-center">
...
const WeatherSkeleton: React.FC = () => (
    <Card className="col-span-2 row-span-2 border-transparent bg-transparent shadow-none">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            Loading....
        </CardHeader> 
    </Card>
