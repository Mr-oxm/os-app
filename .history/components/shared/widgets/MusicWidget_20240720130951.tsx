...
const MusicPlayer = () => {
    ...
    return (
        <div className=" p-4 rounded-lg col-span-8 row-span-2">
            ...
            <Input id="picture" type="file"  className='card bgOpacity bgblur'/>
            <input 
                type="file" 
                accept="audio/*" 
                onChange={handleFileChange}
                className="text-sm file:bgOpacity file:!border-transparent file:transition-all file:hover:!bg-muted border-none w-24 !m-0 file:text-foreground file:card"
            />
        </div>
    );
};
