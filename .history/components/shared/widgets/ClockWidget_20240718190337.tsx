...
const ClockWidget = () => {
    ...
    return (
        <Card className="col-span-4 row-span-2 h-full bg-transparent border-transparent">
            <CardContent className="flex flex-col relative gap-4 items-center justify-center h-full "> 
                <Label className="block text-8xl  text-foreground/50 font-six-caps tracking-widest" style={{ lineHeight: '1' }}>
                    {formatTime(time)}
                </Label>
                <Label className="absolute font-style-script italic text-7xl mt-10 font-bold ">
                    {weekday}
                </Label>
                <Label className="block text-4xl text-foreground/50 font-six-caps tracking-widest">
                    {day}TH {month} {year}
                </Label> 
            </CardContent>
        </Card>
