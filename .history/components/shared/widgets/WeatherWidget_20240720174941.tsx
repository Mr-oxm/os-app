...
const WeatherWidget: React.FC = () => {
    ...
    return (
        <Card className=" !border-transparent bg-transparent shadow-none h-full select-none backdrop-blur-0 hover:!bgOpacity hover:bgblur transition-all ease-in-out card flex flex-col justify-center">
