...
const MusicPlayer = () => {
    ...
    const draw = () => {
        ...
        const textColor = computedStyle.getPropertyValue('--tw-text-opacity');
        ...
        const drawVisual = () => {
          ...
          // Set the fill style to the text color from Tailwind
          canvasCtx.fillStyle = `rgba(var(--color-text-base), ${textColor})`;
    ...
    return (
        <div className=" p-4 rounded-lg col-span-8 row-span-2">
            ...
            <canvas ref={canvasRef} width="1000" height="100" className="mb-4 w-full h-16 " /> 
