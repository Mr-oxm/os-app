...
const ClockWidget = () => {
    ...
    return (
        <div className=" col-span-4 row-span-2 h-full bg-transparent border-transparent flex flex-col relative gap-12 items-center justify-center "> 
                <Label className="block text-9xl  text-foreground/50 font-six-caps tracking-wider" style={{ lineHeight: '1' }}>
                    {formatTime(time)}
                </Label>
                <Label className="absolute font-style-script italic text-8xl mt-14 font-bold ">
                    {weekday}
                </Label>
