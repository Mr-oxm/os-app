...
const MusicPlayer = () => {
    ...
    const draw = useCallback(() => {
        ...
        const drawVisual = () => {
            ...
            const cornerRadius = 2; // Adjust this value to change the roundness of the corners
            let x = 0;
            ...
            for (let i = 0; i < bufferLength; i++) {
                ...
                // Draw top bars
                drawRoundedBar(canvasTopCtx, x, canvasTop.height - barHeight, barWidth, barHeight, cornerRadius);
                
                // Draw bottom bars (flipped)
                drawRoundedBar(canvasBottomCtx, x, 0, barWidth, barHeight, cornerRadius);
    ...
    return (
        <div className=" group !border-transparent bg-transparent shadow-none select-none backdrop-blur-0 hover:!bgOpacity hover:bgblur transition-all ease-in-out card flex flex-col justify-center gap-2 h-full">
            ...
            <div className="flex items-center justify-between opacity-0 group-hover:opacity-100 transition-all ease-in-out">
            ...
            <div className="flex justify-center space-x-4 opacity-0 group-hover:opacity-100 transition-all ease-in-out">
            ...
            <div className="flex items-center opacity-0 group-hover:opacity-100 transition-all ease-in-out">
