...
const WeatherWidget: React.FC = () => {
    ...
    const url = `https://api.openweathermap.org/data/2.5/weather?q=cairo&appid=${process.env.NEXT_PUBLIC_WEATHER_API_KEY}`;
    ...
    return (
        <Card className="col-span-2 row-span-2 bg-transparent border-transparent bgOpacity">
