...
const ClockWidget = () => {
    ...
    return (
        <div className="select-none bg-transparent border-transparent flex flex-col relative gap-10 md:gap-10 items-center justify-center "> 
                <Label className="block text-6xl md:text-9xl  text-foreground/50 font-six-caps tracking-wider" style={{ lineHeight: '1' }}>
                    {formatTime(time)}
                </Label>
                <Label className="absolute font-style-script italic text-5xl md:text-8xl md:mt-16 font-bold ">
                    {weekday}
                </Label>
