...
const MusicPlayer = () => {
    ...
    return (
        <div className=" p-4 rounded-lg md:col-span-4 md:row-span-4 group !border-transparent bg-transparent shadow-none select-none backdrop-blur-0 hover:!bgOpacity hover:bgblur transition-all ease-in-out card flex flex-col justify-center ">
