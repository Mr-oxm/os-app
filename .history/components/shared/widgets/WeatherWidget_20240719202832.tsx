...
const WeatherWidget: React.FC = () => {
    ...
    const url= `https://api.openweathermap.org/data/2.5/weather?q=London&appid=${process.env.NEXT_PUBLIC_WEATHER_API_KEY}`;
    useEffect(() => { 
    ...
    return (
        <div className="card shadow-lg text-foreground col-span-2 row-span-2">
