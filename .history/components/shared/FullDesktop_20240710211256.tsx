...
const FullDesktop = ({ children }: { children: React.ReactNode }) => { 
    ...
    if(isLocked)return(
        ...
        >
            <div className='bgOpacity bgblur w-full h-full flex flex-col items-center just'>
                <Image src="https://icons8.com/icon/kDoeg22e5jUY/male-user" alt="Profile" width={1000} height={1000} className=''/>
            </div>
        </main>
    )
    return (
