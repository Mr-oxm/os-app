    ...
    return (
        ...
        >
            ...
            <div className={`flex relative ${taskbarDir==0? "flex-col":( taskbarDir==1? "flex-row":"flex-row-reverse")} flex-grow w-full items-center`}>
                ...
                <div className='w-full h-20 absolute bottom-0 group/hide'> 
                    <div className='transition-all ease-in-out absolute -bottom-20 group-hover/hide:bottom-1 left-0 right-0'>
