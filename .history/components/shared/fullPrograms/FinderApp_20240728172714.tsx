...
const FileContextMenu: React.FC<{ children: React.ReactNode; item: FileItem; onDelete: () => void; onRename: () => void }> = 
    ...
    <ContextMenu>
        ...
        <ContextMenuContent className='card bgOpacity bgblur'>
            <ContextMenuItem c onClick={() => console.log(`Open ${item.name}`)}>Open</ContextMenuItem>
            <ContextMenuItem c onClick={onDelete}>Delete</ContextMenuItem>
            <ContextMenuItem c onClick={onRename}>Rename</ContextMenuItem>
        </ContextMenuContent>
    </ContextMenu>
);
