...
const PhotoEditor: React.FC = () => {
    ...
    return (
        <div className="flex h-full bgOpacity gap-2 p-2">
            <div className="w-64 bgOpacity card overflow-y-auto p-4">
            ...
            <div className="flex-1 flex gap-4 flex-col items-center p-4 bgOpacity card bgblur overflow-hidden">
            ...
            <div className="w-64 bgOpacity card bgblur overflow-y-auto p-4">
