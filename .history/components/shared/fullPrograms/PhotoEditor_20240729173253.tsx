...
const PhotoEditor = () => {
    ...
    return (
        <div className="flex h-full bgOpacity gap-2">
            ...
            <div className="flex-1 flex gap-4 flex-col items-center p-4 card bgOpacity overflow-hidden">
                ...
                <div className="relative" style={{height: 'calc(100% - 4rem)'}}>
                    <canvas
                        ref={canvasRef}
                        className="border-none bg-red-300/50 absolute top-0 left-1/2"
            ...
            <div className="w-64 bgOpacity card  overflow-y-auto">
                <Tabs defaultValue="adjust">
                    <TabsList className="w-full bgOpacity">
