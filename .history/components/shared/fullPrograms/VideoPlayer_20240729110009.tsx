    ...
    return (
        <Card className="card !rounded-none w-full h-full" ref={playerRef}>
            ...
            >
                ...
                <div className={`absolute top-4 left-4 transition-opacity duration-300 peer-hover:opacity-100 opacity-0 hover:opacity-100 ${isHovering ? 'opacity-100' : 'opacity-0'}`}>
                    <Button
                        variant="ghost"
                        size="icon"
