    ...
    return (
        <div className="relative h-full w-full overflow-hidden">
            ...
            <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex items-center space-x-4">
                {imgSrc ? (
                    <>
                        <Button onClick={retake} variant="secondary" size="icon" className="rounded-full card">
                            <FaUndo />
                        </Button>
                    ...
                    <>
                        <Button onClick={() => setShowControls(!showControls)} variant="secondary" size="icon" className="rounded-full">
                            <FaAdjust />
                        </Button>
                        <Button onClick={capture} variant="secondary" size="icon" className="h-16 w-16 rounded-full">
                        ...
                        {isRecording ? (
                            ...
                            <Button onClick={startRecording} variant="secondary" size="icon" className="rounded-full">
                                <FaVideo />
                            </Button>
                        )}
                    </>
            ...
            {recordedChunks.length > 0 && (
                <div className="absolute top-4 right-4">
                    <Button onClick={saveVideo} variant="secondary">
                        Save Video
                    </Button>
                </div>
            )}
