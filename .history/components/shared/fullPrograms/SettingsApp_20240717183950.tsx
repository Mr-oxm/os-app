...
const SettingsApp = () => {
    ...
    return (
        <div className="flex flex-row w-full h-full p-2 gap-2">
            ...
            <ScrollArea className="md:w-2/3 bgOpacity card h-full w-11/12">
...
const Setting = ({
    ...
    return (
        <Button 
            className={`w-full text-left flex flex-row gap-2 justify-center justify-start text-xs !rounded-full md:card ${
                isSelected 
