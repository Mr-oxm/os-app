                ...
                <div className="absolute top-4 left-4 right-4 card bgOpacity bgblur space-y-4">
                    <div className="flex items-center ">
                        ...
                        <Select onValueChange={(value: Filter) => applyFilter(value)}>
                            <SelectTrigger className='card bgOpacity'>
                                <SelectValue placeholder="Choose a filter" />
                            </SelectTrigger>
                            <SelectContent className='card bgOpacity bgblur'>
                                <SelectItem value="none" className='btn-normal'>None</SelectItem>
                                <SelectItem value="grayscale" className='btn-normal'>Grayscale</SelectItem>
                                <SelectItem value="sepia" className='btn-normal'>Sepia</SelectItem>
                                <SelectItem value="invert" className='btn-normal'>Invert</SelectItem>
                                <SelectItem value="blur" className='btn-normal'>Blur</SelectItem>
                                <SelectItem value="contrast" className='btn-normal'>High Contrast</SelectItem>
                                <SelectItem value="hue-rotate" className='btn-normal'>Hue Rotate</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                    <div className="flex items-center ">
