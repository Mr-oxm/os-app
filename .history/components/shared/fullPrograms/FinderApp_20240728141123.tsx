...
const FinderApp: React.FC = () => {
    ...
    <div className=" w-full h-full flex flex-col gap-2">
            ...
            {sidebarVisible && (
                <div className="w-48 card bgOpacity">
                    <ScrollArea className="h-full">
                        ...
                        <div key={index} className=" rounded-lg hover:bg-accent cursor-pointer">
                            {item}
                        </div>
                        ))}
                    </ScrollArea>
        ...
        <div className="bgOpacity p-4 flex items-center justify-between text-sm text-muted-foreground">
