    ...
    if(isLocked)return(
        ...
        >
            <div className='bgOpacity bgblur w-full h-full flex flex-col items-center justify-center'>
                <Image src="https://images.pexels.com/photos/147411/italy-mountains-dawn-daybreak-147411.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Profile" width={1000} height={1000} className='w-72 h-72'/>
            </div>
        </main>
    )
    return (
