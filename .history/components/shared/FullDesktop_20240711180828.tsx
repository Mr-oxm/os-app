    ...
    return (
        ...
        >
            ...
            <div className={`flex relative ${taskbarDir==0? "flex-col":( taskbarDir==1? "flex-row":"flex-row-reverse")} flex-grow w-full items-center`}>
                ...
                <div className='w-fit'>
                    <span className='absolute w-full bottom-0 left-0 right-0 h-12 peer z-50'></span>
                    <div className=' transition-all ease-in-out absolute -bottom-20 peer-hover:bottom-1'>
