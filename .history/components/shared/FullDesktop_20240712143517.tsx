    ...
    return (
        ...
        >
            ...
            <div className={`flex relative ${taskbarDir==0? "flex-col":( taskbarDir==1? "flex-row":"flex-row-reverse")} flex-grow w-full items-center`}>
                ...
                <HoverCard>
                    <HoverCardTrigger className='text-background w-36 bg-blue-300 absolute bottom-0'><Minus/></HoverCardTrigger>
                    <HoverCardContent className='bg-transparent w-fit border-0 shadow-none h-fit bottom-0 p-0'>
