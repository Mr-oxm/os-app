...
const LayoutSettings: React.FC = () => {
    const { taskbarType, setTaskbarType, topbarType, setTopbarType, windowType, setWindowType, windowDir, setWindowDir, setTaskbarPos, setMainbodyType, mainbodyType } = useAppStore();
    ...
    return (
        <div className="flex flex-col w-full gap-4 max-h-full p-1">
            <div className='bgOpacity card flex flex-col w-full gap-4 max-h-full p-1'>
