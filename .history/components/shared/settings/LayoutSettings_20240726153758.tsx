    ...
    return (
        <div className="flex flex-col w-full gap-4 max-h-full p-1">
            <div className='bgOpacity card flex flex-col w-full gap-4'>
                ...
                {renderButtons("Choose Taskbar Position", taskDirections, taskbarDir, setTaskbarDir, taskbarType===1)} 
                {renderButtons("Choose Taskbar Position", positions, taskbarPos, handleTaskbarPos, taskbarPos===3)} 
            </div>
