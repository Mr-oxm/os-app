...
const PresetsSettings = () => {
    const { setTaskbarType, setTopbarType, setTaskbarDir, setIconsType, setBootAnimation } = useAppStore();
            ...
            <div className="flex flex-col gap-3 p-1">
                {themes.map((t) => (
                    <Button
                        ...
                        className={`card bgOpacity cursor-pointer h-20 overflow-hidden hover:ring-2 ${ === getImageIndex(t) ? 'ring-2 ring-primary' : ''}`}
                    >
