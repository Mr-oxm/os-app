...
const LayoutSettings: React.FC = () => {
    ...
    const handleTaskbarPos= (theme:string){
    ...
    return (
        <div className="flex flex-col w-full gap-4 max-h-full p-1">
            <div className='bgOpacity card flex flex-col w-full gap-4'>
                ...
                {renderButtons("Choose Taskbar Position", taskDirections, taskbarDir, setTaskbarDir, taskbarType===3)} 
                {renderButtons("Choose Taskbar Position", positions, taskbarPos, setTaskbarPos, taskbarPos===1)} 
            </div>
