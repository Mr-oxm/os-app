...
const PresetsSettings = () => {
    const { setTaskbarType, setTopbarType, setTaskbarDir, setIconsType, setBootAnimation, setWindowType, setWindowDir, setWallpaper } = useAppStore();
    ...
    const handlePreset=({index}:{index:number})=>{
        ...
        setIconsType(index);
        setWindowType(index);
        (index===0)? setWindo0wDir(0):setWindowDir(1);
        (index===2)? setTaskbarDir(2):setTaskbarDir()
    }
