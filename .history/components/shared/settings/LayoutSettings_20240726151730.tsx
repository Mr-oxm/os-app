...
const LayoutSettings: React.FC = () => {
    const { taskbarType, setTaskbarType, topbarType, setTopbarType, windowType, setWindowType, windowDir, setWindowDir, setTaskbarPos, setMainbodyType, mainbodyType, taskbarDir, taskbarPos, setTaskbarDir, setTa } = useAppStore();
