        ...
        <div className="flex flex-col w-full max-h-full">
            ...
            <div className="flex flex-col gap-3">
                {themes.map((t) => (
                    <Button
                        key={t}
                        onClick={() => setIconsType(t)}
                        className={`card bgOpacity cursor-pointer h-20 overflow-hidden hover:ring-2 ${iconsType === t ? 'ring-2 ring-primary' : ''}`}
                    >
