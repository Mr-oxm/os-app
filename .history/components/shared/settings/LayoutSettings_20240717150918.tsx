...
const LayoutSettings: React.FC = () => {
    const { taskbarType, setTaskbarType, topbarType, setTopbarType, windowType, setWindowType, windowDir, setWindowDir, setTaskbarPos } = useAppStore();
    ...
    return (
        <div className="flex flex-col w-full max-h-full px-1">
