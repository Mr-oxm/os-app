        ...
        <div className="p-4">
            ...
            <div className="grid grid-cols-4 gap-4">
                {wallpapers.map((wallpaper, index) => (
                    <div 
                        key={index} 
                        className={`relative card bgOpacity cursor-pointer h-28 overflow-hidden ${selectedWallpaper === wallpaper ? 'ring-2 ring-primary' : ''}`}
                    ...
                    >
                        <Image 
                            ...
                            width={200}
                            height={150}
                            className="object-cover card !p-0 w-full h-full border"
                        />
                    </div>
                ))}
            </div>
