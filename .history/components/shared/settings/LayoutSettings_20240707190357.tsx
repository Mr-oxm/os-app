        ...
        <div className="flex flex-col w-full max-h-full">
            ...
            <div className="flex flex-row gap-3">
                <Button 
                    ...
                    className={`card bgOpacity cursor-pointer h-20 overflow-hidden hover:ring-2 ${windowType === 0 ? 'ring-2 ring-primary' : ''}`}
                >
                    <Label className='w-20'>Left</Label>
                </Button> 
                <Button 
                    onClick={() => setWindowDir(1)}
                    className={`card bgOpacity cursor-pointer h-20 overflow-hidden hover:ring-2 ${windowType === 1 ? 'ring-2 ring-primary' : ''}`}
                >
