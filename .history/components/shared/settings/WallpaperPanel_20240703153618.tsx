        ...
        <div className="flex flex-col w-full max-h-full">
            ...
            <div className="grid grid-cols-4 gap-3 overflow-y-scroll p-1 max-h-full">
                {wallpapers.map((wallpaper, index) => (
                    <div 
                        key={index} 
                        className={`card bgOpacity cursor-pointer h-48 overflow-hidden hover:!bg-primary hover:!text-primary-foreground ${currentWallpaper === wallpaper ? 'ring-2 ring-primary' : ''}`}
