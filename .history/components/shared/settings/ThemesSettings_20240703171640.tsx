...
const ThemesSettings = () => {
    ...
    const ThemeButton=({themeName}:{themeName:string})=>{return(
        <Button className={`overflow-hidden text-xs !p-0 card bgOpacity w-1/5 h-fit cursor-pointer flex flex-col justify-start ${themeName} text-foreground hover:ring-2 ${color===themeName? 'ring-2 ring-primary': ''}`} onClick={() => setTheme(themeName)}>
    ...
    return (
        <div className="h-full">
            ...
            <div className="flex flex-row flex-wrap gap-2 overflow-y-scroll p-1"> 
                ...
                <ThemeButton themeName="windows11-dark"/> 
