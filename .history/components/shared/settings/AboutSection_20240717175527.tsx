    ...
    return (
        <div className="flex flex-col p-1 gap-2 items-center justify-start">
            ...
            <div className="w-full flex flex-col gap-1 items-center card bgOpacity ">
                ...
                <p>OXM OS is a web-based operating system developed by me Omar Emara. It was designed to showcase my web development skills and serve as my portofolio in the future. The intial goal of this OS is to enable the user to customize how their desktop look from the fots to the </p>
            </div>
        </div>
    )
}
