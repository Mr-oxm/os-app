...
const ThemesSettings = () => {
    ...
    const ThemeButton=({themeName}:{themeName:string})=>{return(
        <Button className={`card bgOpacity w-1/5 h-48 cursor-pointer flex flex-col justify-start ${themeName} text-foreground`} onClick={() => setTheme(themeName)}>
            <div className="bg-background p-2 capitalize w-full">
                {themeName}
            </div>
            <div className="bgOpacity p-2 capitalize w-full">
