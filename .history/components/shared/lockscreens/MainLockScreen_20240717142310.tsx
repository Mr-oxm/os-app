            ...
            >
                <div className='bgOpacity bgblur w-full h-full flex flex-col items-center gap-4 justify-center'>
                    ...
                    <Button 
                        ...
                        className='bgBlur bgOpacity text-foreground w-24 card hover:!bg-foreground/ active:!bg-primary active:!text-primary-foreground transition-all ease-in-out active: active:scale-110 animate-fadeIn'
                    >
                        Enter
                    </Button>
                </div>
