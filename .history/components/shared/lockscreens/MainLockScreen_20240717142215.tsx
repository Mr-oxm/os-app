            ...
            >
                <div className='bgOpacity bgblur w-full h-full flex flex-col items-center gap-4 justify-center'>
                    ...
                    <Button 
                        ...
                        className='bgBlur bgOpacity text-foreground w-24 card hover:!bg-primary hover:!text-primary-foreground transition-all duration-300 active:scale-110 animate-fadeIn'
                    >
                        Enter
                    </Button>
                </div>
