...
export const systemThemes=[
    'light', 'dark','windows11-light','windows11-dark', 'ubuntu-light', 'ubuntu-dark','elementary-light', 'elementary-dark', "retro-amber", 'retro-green', 'high-contrast-light', 'cssCopy  .high-contrast-dark'
]