import {LayoutGrid, Palette, Wallpaper, LayoutTemplate} from "lucide-react" 
...
export const settingsMenu= [
    ...
    {name:"Taskbar", icon: <LayoutGrid className="w-4 h-4"/>},
    {name:"Cursor", icon: <LayoutGrid className="w-4 h-4"/>},
