...
export const settingsMenu= [
    {name:"Theme", icon: <Palette className="w-4 h-4"/>, component:<ThemesSettings/>},
    {name:"Wallpaper", icon: <Wallpaper className="w-4 h-4"/>, component:<WallpaperPanel/>},
    {name:"Icons", icon: <LayoutGrid className="w-4 h-4"/>, component:""},
]
